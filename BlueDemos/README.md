...
**3)** Find your _**external_ip**_ and _**external_port**_ definition as shown in the picture below. You need both of these values in Lab 2, so make a note of them.
